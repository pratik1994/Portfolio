  ...
  state = {
    services: [
      ...
      },
      {
        ...
        title: "Experiance",
        info:
          "3.3 years of Experiance worked with Tech Mahindra for 2Years and currenty working with Enquero for 1.3 yrs",
      },
      {
        icon: <GiTechnoHeart />,
        title: "Tech Stack",
        info:
          "Javascript, React, React-Native , Xamarin (forms & android), Android (native), Node",
      },
      {
        icon: <FaBirthdayCake />,
        title: "Personal Background",
        info:
          "25 yrs Born and brought up in Rajasthan, currently working in bangalore",
      },
    ],
  };
  render() {
